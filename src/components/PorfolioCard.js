    ...
    <div className="flex m-5">
      <div className="bg-gray-200 shadow-md rounded-lg p-8 w-full max-w-md">
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-2 flex font-bold">
            <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="betPrice">Bet Price:</label>
            <label className='text-cyan mx-2'>{props.Bet_Price}</label>
          </div>
          <div className="mb-2 flex font-bold">
            <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="betPrice">Winning Amount:</label>
